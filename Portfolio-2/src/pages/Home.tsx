      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* E-Commerce Website */}
            <div className="card overflow-hidden hover:shadow-lg transition-all animate-fade-in" style={{ animationDelay: "100ms" }}>
              <div className="h-60 bg-gray-200 dark:bg-gray-700">
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-r from-light-accent-secondary to-gray-200 dark:from-dark-accent-secondary dark:to-gray-700">
                  <span className="text-light-text-secondary dark:text-dark-text-secondary font-medium">E-Commerce Website</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
                  A fully functional e-commerce website built using the MERN stack, featuring user authentication, product search, and payment integration.
                </p>
                <div className="flex flex-wrap gap-2 mb-6">
                  <span className="bg-light-accent-secondary dark:bg-dark-accent-secondary text-light-text-primary dark:text-dark-text-primary text-xs px-2 py-1 rounded">MongoDB</span>
                  <span className="bg-light-accent-secondary dark:bg-dark-accent-secondary text-light-text-primary dark:text-dark-text-primary text-xs px-2 py-1 rounded">Express.js</span>
                  <span className="bg-light-accent-secondary dark:bg-dark-accent-secondary text-light-text-primary dark:text-dark-text-primary text-xs px-2 py-1 rounded">React</span>
                  <span className="bg-light-accent-secondary dark:bg-dark-accent-secondary text-light-text-primary dark:text-dark-text-primary text-xs px-2 py-1 rounded">Node.js</span>
                </div>
                <Link to="/projects">
